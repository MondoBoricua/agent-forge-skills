---
name: macos-dev-pro
description: Comprehensive pro-level macOS development guidance including Swift 6+, SwiftUI, SwiftData, architecture patterns, AppKit bridging, menu bar utilities, system monitoring, and macOS 26 Tahoe APIs. Use for macOS code review, best practices, UI review, platform-specific features, status menu apps, or local system-monitoring utilities.
...
- `system-monitoring.md` - CPU/GPU/RAM/disk/power metrics, Process pitfalls, and utility app patterns
