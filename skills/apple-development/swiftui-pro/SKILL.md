---
name: swiftui-pro
description: Use when writing, reviewing, or refactoring production SwiftUI code for iOS or macOS, including state management, view composition, menu bar utilities, WindowGroup/MenuBarExtra behavior, performance, Liquid Glass adoption, or Instruments `.trace` capture/analysis for hangs, hitches, CPU hotspots, or
...
| macOS menu bar/status utilities | `references/macos-scenes.md` |
